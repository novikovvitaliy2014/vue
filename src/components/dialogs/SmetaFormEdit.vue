  ...
  export default {
    ...
    created(){
      if(this.project.data){
        ...
        this.smetaName1 = data.smetaName1 ? data.smetaName1 : ""
        this.smetaQuantity1 = data.smetaQuantity1 ? data.smetaQuantity1 : ""
        this.smetaPrice1 = data.smetaPrice1 ? data.smetaPrice1 : ""
        this.smetaName2 = data.smetaName2 ? data.smetaName2 : ""
        this.smetaQuantity2 = data.smetaQuantity2 ? data.smetaQuantity2 : ""
        this.smetaPrice2 = data.smetaPrice2 ? data.smetaPrice2 : ""
        this.smetaName3 = data.smetaName3 ? data.smetaName3 : ""
        this.smetaQuantity3 = data.smetaQuantity3 ? data.smetaQuantity3 : ""
        this.smetaPrice3 = data.smetaNPrice3 ? data.smetaPrice3 : ""
        this.smetaName4 = data.smetaName4 ? data.smetaName4 : ""
        this.smetaQuantity4 = data.smetaQuantity4 ? data.smetaQuantity4 : ""
        this.smetaPrice4 = data.smetaPrice4 ? data.smetaPrice4 : ""
        this.smetaName5 = data.smetaName5 ? data.smetaName5 : ""
        this.smetaQuantity5 = data.smetaQuantity5 ? data.smetaQuantity5 : ""
        this.smetaPrice5 = data.smetaPrice5 ? data.smetaPrice5 : ""
      }
